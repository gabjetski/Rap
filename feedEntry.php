...
class feedEntry
{
    ...
    function getPlayerCodeMain()
    {
        ...
        if ($this->fileData['monet'] == 1) {
            ...
            $returnCode .= "<a href=\"index.php?downloaded_file={$this->fileData['downloadPath']}&username_file={$this->uploaderData['username']}&title_file={$this->fileData['title']}\" ";
            if ($showDownload) {
